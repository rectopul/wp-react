...
class Swp_Portfolio_Isotop extends Widget_Base
{
    ...
    {
        return esc_html__('Isotop', 'swp-portfolio');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .swp-single-inner.style-4:before',
                'show_label' => true
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .swp-single-inner.style-3:after, {{WRAPPER}} .swp-single-inner.style-7:after,
                    {{WRAPPER}} .swp-single-inner.style-4:after,{{WRAPPER}} .swp-single-inner.style-5:after',
            ]
        );
    ...
    protected function render()
    {
        ...
        if ($settings['style'] == 'style-2') { ?>
            <section class="portfolio-area style-2 <?php echo esc_attr($ajaxclass); ?>" data-filter-section="<?php echo esc_attr(uniqid()); ?>" data-swp_ajaxid="<?php echo esc_attr($this->get_id()); ?>" data-style="isotope-style-two">
                <div class="swp-container">
                    <div class="modal"></div>
                    <?php

                    include SWP_PORTFOLIO_ELEMENTOR . '/templates/isotope-style-two.php';
        ...
        <?php } elseif ($settings['style'] == 'style-3') { ?>
            <section class="portfolio-area style-3 <?php echo esc_attr($ajaxclass); ?>" data-filter-section="<?php echo esc_attr(uniqid()); ?>" data-swp_ajaxid="<?php echo esc_attr($this->get_id()); ?>" data-style="isotope-style-three">
                <div class="swp-container ">
                    <div class="modal"></div>
                    <?php

                    include SWP_PORTFOLIO_ELEMENTOR . '/templates/isotope-style-three.php';
        ...
        <?php } elseif ($settings['style'] == 'style-4') { ?>
            <section class="portfolio-area style-4 <?php echo esc_attr($ajaxclass); ?>" data-filter-section="<?php echo esc_attr(uniqid()); ?>" data-swp_ajaxid="<?php echo esc_attr($this->get_id()); ?>" data-style="isotope-style-four">
                <div class="swp-container">
                    <div class="modal"></div>
                    <?php

                    include SWP_PORTFOLIO_ELEMENTOR . '/templates/isotope-style-four.php';
        ...
        <?php  } elseif ($settings['style'] == 'style-5') { ?>
            <section class="portfolio-area style-5 <?php echo esc_attr($ajaxclass); ?>" data-filter-section="<?php echo esc_attr(uniqid()); ?>" data-swp_ajaxid="<?php echo esc_attr($this->get_id()); ?>" data-style="isotope-style-five">
                <div class="swp-container">
                    <div class="modal"></div>
                    <?php

                    include SWP_PORTFOLIO_ELEMENTOR . '/templates/isotope-style-five.php';
        ...
        <?php } else { ?>
            <section class="portfolio-area style-7 <?php echo esc_attr($ajaxclass); ?>" data-filter-section="<?php echo esc_attr(uniqid()); ?>" data-swp_ajaxid="<?php echo esc_attr($this->get_id()); ?>" data-style="isotope-style-one">
                <div class="swp-container">
                    <div class="modal"></div>
                    <?php

                    include SWP_PORTFOLIO_ELEMENTOR . '/templates/isotope-style-one.php';
