...
<div class="swpisotopefilter">
    <div class="isotope-filters swp-isotope-btn text-lg-left text-center">
        <?php if ($settings['hide_filter'] != 'yes') : ?>
    ...
    <div class="swp-section">
        <div class="swp-isotope swp-row swp-no-gutters">
            ...
            ?>
                    <div class="swp-item swp-col-lg-3 swp-col-sm-6 <?php foreach ($terms as $term) {
                                                                        echo strtolower(preg_replace('/[^a-zA-Z]+/', '-', $term->slug)) . ' ';
                                                                    } ?>">
                        <div class="swp-single-inner style-12">
                            <div class="icon-img">
                                <?php
                                if (has_post_thumbnail()) :
                                    the_post_thumbnail('swp-portfolio-masonry-four');
                                endif;
                                ?>
