                ...
                <div class="swp-single-inner style-19">
                    ...
                    <div class="content-box">
                        ...
                        ?>
                            ...
                            <?php if ($settings['portfolio-url'] == 'default') : ?>
                                <a <?php echo esc_attr(!empty($settings['open-url']) ? 'target="_blank"' : ''); ?> class="swp-readmore-text" href="<?php the_permalink(); ?>"><?php echo esc_html__('Read More', 'swp-portfolio'); ?> <i class="fas fa-angle-double-right"></i></a>
                            <?php else : ?>
                                <a <?php echo esc_attr(!empty($settings['open-url']) ? 'target="_blank"' : ''); ?> class="swp-readmore-text" href="<?php echo esc_url($swp_meta[0]['url']); ?>"><?php echo esc_html__('Read More', 'swp-portfolio'); ?> <i class="fas fa-angle-double-right"></i></a>
                            <?php endif; ?>
                    </div>
                </div>
            </div>
